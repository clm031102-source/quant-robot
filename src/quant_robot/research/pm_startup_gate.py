...
from quant_robot.research.term_structure_study import scope as term_structure_scope
from quant_robot.research.enterprise_liquidity_cadence_study import scope as enterprise_cadence_scope
...
def build_quant_pm_startup_gate(
    *,
    ...
    diagnostic_scopes = [scope for scope in (
        ...
        term_structure_scope(task, resolved_family_config, family_schedule, root=root, branch=selected_branch),
        enterprise_cadence_scope(task, resolved_family_config, family_schedule, root=root, branch=selected_branch),
    ...
    if restricted_mode == "source_repair_only":
        ...
        warnings.append("research_family_scheduler_single_currency_gold_cadence_mode")
    elif restricted_mode == "single_credit_premium_cadence_only":
        warnings.append("research_family_scheduler_single_credit_premium_cadence_mode")
    elif restricted_mode == "single_enterprise_cadence_only":
        warnings.append("research_family_scheduler_single_enterprise_cadence_mode")
    ...
    pack = {
        ...
        "safety": {
            ...
            "currency_gold_cadence_scope": _dict(restricted.get("scope")) if restricted_mode == "single_currency_gold_cadence_only" else {},
            "credit_premium_cadence_allowed": not blockers and restricted_mode == "single_credit_premium_cadence_only",
            "credit_premium_cadence_scope": _dict(restricted.get("scope")) if restricted_mode == "single_credit_premium_cadence_only" else {},
            "enterprise_cadence_allowed": not blockers and restricted_mode == "single_enterprise_cadence_only",
            "enterprise_cadence_scope": _dict(restricted.get("scope")) if restricted_mode == "single_enterprise_cadence_only" else {},
...
def _next_actions(
    ...
    *,
    ...
    if restricted_mode == "single_currency_gold_cadence_only":
        return [{"action": "run_registered_currency_gold_cadence_without_outcomes",
                 "command": "python scripts/run_cn_etf_currency_gold_cadence.py --execute"}]
    if restricted_mode == "single_credit_premium_cadence_only":
        return [{"action": "run_registered_credit_premium_cadence_without_outcomes",
                 "command": "python scripts/run_cn_etf_credit_premium_cadence.py --execute"}]
    if restricted_mode == "single_enterprise_cadence_only":
        return [{"action": "run_registered_enterprise_cadence_without_outcomes",
                 "command": "python scripts/run_cn_etf_enterprise_liquidity_cadence.py --execute"}]
