    ...
    return _sanitize(
        {
            ...
            "train_annualized_return": _metric(train, "annualized_return"),
            "test_annualized_return": _metric(test, "annualized_return"),
            ...
            "mean_test_annualized_return": _metric(test, "annualized_return"),
            "mean_test_relative_return": test_relative_return,
            "mean_test_win_rate": _metric(test, "win_rate"),
    ...
    return _sanitize(
        {
            ...
            **_aggregate_split_evidence(rows),
            ...
            "train_annualized_return": _mean_metric(rows, "train_annualized_return"),
            "test_annualized_return": _mean_metric(rows, "test_annualized_return"),
            "mean_test_annualized_return": _mean_metric(rows, "test_annualized_return"),
