...
_INCOME_STATEMENT_NUMERIC_COLUMNS = [column for column in INCOME_STATEMENT_COLUMNS if column not in STATEMENT_KEY_COLUMNS + ["netprofit"]]
_BALANCE_SHEET_NUMERIC_COLUMNS = [column for column in BALANCE_SHEET_COLUMNS if column not in STATEMENT_KEY_COLUMNS]
_CASHFLOW_STATEMENT_NUMERIC_COLUMNS = [column for column in CASHFLOW_STATEMENT_COLUMNS if column not in STATEMENT_KEY_COLUMNS]
