...
from quant_robot.ops.public_alpha101_reference_exposure_dedup import (  # noqa: E402
    DEFAULT_HORIZON,
    DEFAULT_LEAD_FACTOR_NAME,
    build_public_alpha101_reference_exposure_dedup,
    write_public_alpha101_reference_exposure_dedup,
)
...
DEFAULT_PRESCREEN_REPORT = Path(
    "data/reports/public_alpha101_capacity_safe_prescreen_round115_20260622/public_alpha101_capacity_safe_prescreen.json"
)
DEFAULT_OUTPUT_DIR = Path("data/reports/public_alpha101_reference_exposure_dedup")


def run_public_alpha101_reference_exposure_dedup_cli(
    *,
    ...
    result = build_public_alpha101_reference_exposure_dedup(
    ...
    write_public_alpha101_reference_exposure_dedup(output_dir, result)
    return result


def main() -> None:
    parser = argparse.ArgumentParser(
        description="Run Round116 reference and exposure dedup audit for the public Alpha101/Qlib lead."
    )
