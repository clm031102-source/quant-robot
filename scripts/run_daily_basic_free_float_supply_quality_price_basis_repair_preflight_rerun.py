...
from quant_robot.ops.daily_basic_free_float_supply_quality_price_basis_repair_preflight_rerun import (  # noqa: E402
    ...
    build_daily_basic_free_float_supply_quality_price_basis_repair_preflight_rerun,
    write_daily_basic_free_float_supply_quality_price_basis_repair_preflight_rerun,
)
...
def run_daily_basic_free_float_supply_quality_price_basis_repair_preflight_rerun_cli(
    *,
    ...
    result = build_daily_basic_free_float_supply_quality_price_basis_repair_preflight_rerun(
    ...
    write_daily_basic_free_float_supply_quality_price_basis_repair_preflight_rerun(output_dir, result)
    return result
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description=(
            "Run Round138 price-basis repaired rerun for the frozen daily-basic free-float supply quality candidate."
        )
    )
        ...
        json.dumps(
            {
                ...
                "price_basis_repair_summary": result["price_basis_repair_summary"],
