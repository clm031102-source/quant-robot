...
from quant_robot.ops.negative_ic_trend_accumulation_lead_dedup import (  # noqa: E402
    DEFAULT_LEAD_FACTOR_NAME,
    DEFAULT_LEAD_HORIZON,
    build_negative_ic_trend_accumulation_lead_dedup,
    write_negative_ic_trend_accumulation_lead_dedup,
)
...
DEFAULT_PRESCREEN_REPORT = Path(
    "data/reports/negative_ic_trend_accumulation_prescreen_round107_20260622/negative_ic_trend_accumulation_prescreen.json"
)
DEFAULT_OUTPUT_DIR = Path("data/reports/negative_ic_trend_accumulation_lead_dedup")


def run_negative_ic_trend_accumulation_lead_dedup_cli(
    *,
    ...
    write_negative_ic_trend_accumulation_lead_dedup(output_dir, result)
    return result


def main() -> None:
    parser = argparse.ArgumentParser(
        description="Run Round108 correlation, capacity, and extreme-trade audit for the Round107 CN stock lead."
    )
        ...
        json.dumps(
            {
                ...
                "capacity_audit": result.get("capacity_audit", {}),
