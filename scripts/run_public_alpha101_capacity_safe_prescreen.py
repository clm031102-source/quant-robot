...
from quant_robot.ops.public_alpha101_capacity_safe_prescreen import (  # noqa: E402
    DEFAULT_ANALYSIS_END_DATE,
    DEFAULT_ANALYSIS_START_DATE,
    build_public_alpha101_capacity_safe_prescreen,
    write_public_alpha101_capacity_safe_prescreen,
)


DEFAULT_OUTPUT_DIR = Path("data/reports/public_alpha101_capacity_safe_prescreen")


def run_public_alpha101_capacity_safe_prescreen_cli(
    *,
    ...
    write_public_alpha101_capacity_safe_prescreen(output_dir, result)
    return result


def main() -> None:
    parser = argparse.ArgumentParser(
        description="Run CN stock public Alpha101/Qlib-style IC/quantile/turnover prescreen."
    )
