...
from quant_robot.ops.lpr_macro_regime_factor_value_reconstruction_smoke import (  # noqa: E402
    run_lpr_macro_regime_factor_value_reconstruction_smoke,
)


DEFAULT_PROCESSED_ROOT = Path("data/processed/round695_external_feeds_lpr_repaired_20260709")
DEFAULT_PREFLIGHT = Path(
    "data/reports/round733_lpr_macro_regime_reference_dedup_preflight_20260709/lpr_macro_regime_reference_dedup_preflight.json"
)
DEFAULT_BARS_ROOTS = (
...
DEFAULT_OUTPUT_DIR = Path("data/reports/round734_lpr_macro_regime_factor_value_reconstruction_smoke_20260709")


def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Run LPR macro regime factor-value reconstruction smoke.")
    ...
    result = run_lpr_macro_regime_factor_value_reconstruction_smoke(
