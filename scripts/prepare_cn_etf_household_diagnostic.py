"""Prepare the reviewed household source registration without granting execution."""
import argparse
import json
...
from quant_robot.research.household_diagnostic_inputs import check_source_links
