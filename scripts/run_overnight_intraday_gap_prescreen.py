...
from quant_robot.ops.overnight_intraday_gap_prescreen import (  # noqa: E402
    build_overnight_intraday_gap_prescreen,
    write_overnight_intraday_gap_prescreen,
)
...
DEFAULT_OUTPUT_DIR = Path("data/reports/overnight_intraday_gap_prescreen")


def run_overnight_intraday_gap_prescreen_cli(
    *,
    ...
    result = build_overnight_intraday_gap_prescreen(
    ...
    write_overnight_intraday_gap_prescreen(output_dir, result)
    return result


def main() -> None:
    parser = argparse.ArgumentParser(
        description="Run long-cycle IC, quintile, turnover, and capacity prescreen for CN stock overnight/intraday gap candidates."
    )
