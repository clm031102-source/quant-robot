...
from quant_robot.ops.high_52week_quality_prescreen import (  # noqa: E402
    DEFAULT_CANDIDATE_PLAN,
    build_high_52week_quality_prescreen,
    write_high_52week_quality_prescreen,
)
...
DEFAULT_OUTPUT_DIR = Path("data/reports/high_52week_quality_prescreen")


def run_high_52week_quality_prescreen_cli(
    *,
    ...
    write_high_52week_quality_prescreen(output_dir, result)
    return result


def main() -> None:
    parser = argparse.ArgumentParser(
        description="Run CN stock 52-week high quality IC, quintile, turnover, and multiple-testing prescreen."
    )
    ...
    result = run_high_52week_quality_prescreen_cli(
        bars_roots=bars_roots,
