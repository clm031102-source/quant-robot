...
def run_gui_browser_smoke(
    ...
    checks.append(
        _check(
            ...
            and "post-close-broker-recheck-session-decision" in str(index_html.get("body", ""))
            and app_js.get("ok")
            and "renderBeginnerPostCloseJournal" in str(app_js.get("body", ""))
            and "beginnerPostCloseJournalRows" in str(app_js.get("body", ""))
            and "broker_price_recheck_session_decision" in str(app_js.get("body", ""))
            and "broker_recheck_session_ok" in str(app_js.get("body", ""))
            and "broker_recheck_session_missing" in str(app_js.get("body", ""))
            and "broker_recheck_session_not_ok" in str(app_js.get("body", ""))
            and "broker_recheck_session_missing_count" in str(app_js.get("body", ""))
            and "broker_recheck_session_blocked_count" in str(app_js.get("body", ""))
    ...
    checks.append(
        _check(
            ...
            and "estimated_commission_bps" in str(app_js.get("body", ""))
            and "estimated_commission_cost" in str(app_js.get("body", ""))
            and "estimated_total_execution_cost" in str(app_js.get("body", ""))
            and "estimated_total_execution_cost_bps" in str(app_js.get("body", ""))
    ...
    checks.append(
        _check(
            ...
            and "row_action_code" in str(app_js.get("body", ""))
            and "row_action_label" in str(app_js.get("body", ""))
            and "plain_row_instruction" in str(app_js.get("body", ""))
            and "逐行结论=" in str(app_js.get("body", ""))
            ...
            and "brokerPriceRecheckSessionVerdict" in str(app_js.get("body", ""))
            and "data-broker-price-recheck-session-output" in str(app_js.get("body", ""))
            ...
            and "broker_price_recheck_session_verdict" in str(app_js.get("body", ""))
            and "external_available_cash_after_manual_check" in str(app_js.get("body", ""))
            and "external_cash_shortfall" in str(app_js.get("body", ""))
            and "recalculated_commission_cost_at_external_price" in str(app_js.get("body", ""))
            and "recalculated_cash_required_at_external_price" in str(app_js.get("body", ""))
            and "recalculated_cash_released_at_external_price" in str(app_js.get("body", ""))
            and "externalCash < recalculatedCashRequired" in str(app_js.get("body", ""))
            and 'data-side="${escapeRawHtml(item.side || "")}"' in str(app_js.get("body", ""))
            and "effective_target_value_for_recalculation" in str(app_js.get("body", ""))
            and "small_capital_recheck_budget_applied" in str(app_js.get("body", ""))
            and "data-small-capital-capped-notional" in str(app_js.get("body", ""))
            and "waiting_for_all_external_inputs" in str(app_js.get("body", ""))
            and "manual_review_price_ok_quantity_recalculated" in str(app_js.get("body", ""))
            and "manual_review_all_rows_price_cash_ok" in str(app_js.get("body", ""))
            and "manual_review_some_rows_skipped_or_blocked" in str(app_js.get("body", ""))
    ...
    checks.append(
        _check(
            ...
            and "small_capital_budget" in str(app_js.get("body", ""))
            and "small_capital_capped_notional" in str(app_js.get("body", ""))
            and "small_capital_limit_breached" in str(app_js.get("body", ""))
