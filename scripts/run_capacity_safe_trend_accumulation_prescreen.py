...
from quant_robot.ops.capacity_safe_trend_accumulation_prescreen import (  # noqa: E402
    build_capacity_safe_trend_accumulation_prescreen,
    write_capacity_safe_trend_accumulation_prescreen,
)
...
DEFAULT_OUTPUT_DIR = Path("data/reports/capacity_safe_trend_accumulation_prescreen")


def run_capacity_safe_trend_accumulation_prescreen_cli(
    *,
    ...
    write_capacity_safe_trend_accumulation_prescreen(output_dir, result)
    return result
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description=(
            ...
            "for CN stock trend/amount accumulation candidates."
        )
    )
