...
from quant_robot.ops.public_tradeable_indicator_composite_residual_prescreen import (  # noqa: E402
    build_public_tradeable_indicator_composite_residual_prescreen,
...
DEFAULT_OUTPUT_DIR = Path("data/reports/round265_public_tradeable_indicator_composite_residual_prescreen_20260626")


def run_public_tradeable_indicator_composite_residual_prescreen_cli(
    *,
    ...
    if factor_frame is not None and labels is not None:
        ...
        result = build_public_tradeable_indicator_composite_residual_prescreen(
    ...
    write_public_tradeable_indicator_composite_residual_prescreen(output_dir, result)
    return result


def main() -> None:
    parser = argparse.ArgumentParser(
        description="Run Round265 public tradeable indicator composite residual IC, shape, turnover, 2015, and reference-overlap prescreen."
    )
    ...
    parser.add_argument("--min-quantile-monotonicity", type=float, default=0.50)
    parser.add_argument("--max-top-quantile-turnover", type=float, default=0.90)
    ...
    result = run_public_tradeable_indicator_composite_residual_prescreen_cli(
        ...
        candidate_factor_names=tuple(args.candidate_factor_names or round264_candidate_names()),
        ...
        min_quantile_monotonicity=args.min_quantile_monotonicity,
