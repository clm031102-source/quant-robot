...
from quant_robot.ops.cn_tradeability_limit_event_proxy_prescreen import (  # noqa: E402
    build_cn_tradeability_limit_event_proxy_prescreen,
...
DEFAULT_PREREGISTRATION_JSON = Path(
    "data/reports/cn_tradeability_limit_event_preregistration_round159_20260623/cn_tradeability_limit_event_preregistration.json"
)
DEFAULT_OUTPUT_DIR = Path("data/reports/cn_tradeability_limit_event_proxy_prescreen_round160_20260623")


def run_cn_tradeability_limit_event_proxy_prescreen_cli(
    *,
    ...
    result = build_cn_tradeability_limit_event_proxy_prescreen(
    ...
    write_cn_tradeability_limit_event_proxy_prescreen(output_dir, result)
    return result


def main() -> None:
    parser = argparse.ArgumentParser(description="Run Round160 CN tradeability limit-event proxy prescreen.")
