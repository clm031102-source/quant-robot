...
from quant_robot.ops.market_residual_risk_premia_prescreen import (  # noqa: E402
    DEFAULT_ANALYSIS_END_DATE,
    DEFAULT_ANALYSIS_START_DATE,
    DEFAULT_HORIZONS,
    build_market_residual_risk_premia_prescreen,
    write_market_residual_risk_premia_prescreen,
)
...
DEFAULT_OUTPUT_DIR = Path("data/reports/market_residual_risk_premia_prescreen")


def run_market_residual_risk_premia_prescreen_cli(
    *,
    ...
    write_market_residual_risk_premia_prescreen(output_dir, result)
    return result


def main() -> None:
    parser = argparse.ArgumentParser(
        description="Run long-cycle Alphalens-style IC, quantile, turnover, and residual market-risk prescreen for CN stock candidates."
    )
