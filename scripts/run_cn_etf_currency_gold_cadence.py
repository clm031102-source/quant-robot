"""Preflight or run one frozen conditional currency-gold cadence screen."""
import argparse
import json
...
def run(root, *, execute=False):
    ...
    return {'status': 'completed', 'cadence_screen': result['screen'], 'result_path': study.DIRECTORY+'/result.json'}
