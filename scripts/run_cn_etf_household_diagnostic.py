"""Preflight or execute the exact separately admitted household gross diagnostic."""
import argparse
import json
...
from quant_robot.research.household_diagnostic_execution import execute_registration, preflight_registration
