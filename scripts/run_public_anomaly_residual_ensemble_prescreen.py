...
from quant_robot.factors.daily_basic_public_anomaly_residual_ensemble import (  # noqa: E402
...
from quant_robot.ops.public_anomaly_residual_ensemble_prescreen import (  # noqa: E402
    build_public_anomaly_residual_ensemble_prescreen,
    build_public_anomaly_residual_ensemble_sharded_prescreen,
...
DEFAULT_OUTPUT_DIR = Path("data/reports/public_anomaly_residual_ensemble_prescreen_round229_20260624")


def run_public_anomaly_residual_ensemble_prescreen_cli(
    *,
    ...
    if factor_frame is not None and labels is not None:
        ...
        result = build_public_anomaly_residual_ensemble_sharded_prescreen(
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Run Round229 public anomaly residual ensemble long-cycle residual prescreen."
    )
    ...
    result = run_public_anomaly_residual_ensemble_prescreen_cli(
        ...
        candidate_factor_names=tuple(args.candidate_factor_names or DAILY_BASIC_PUBLIC_ANOMALY_RESIDUAL_ENSEMBLE_FACTOR_NAMES),
