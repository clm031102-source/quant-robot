...
from quant_robot.ops.clean_technical_portfolio_diagnostic import (  # noqa: E402
...
DEFAULT_OUTPUT_DIR = Path("data/reports/clean_technical_portfolio_diagnostic")
DEFAULT_CANDIDATES = (
    "momentum_20",
    "momentum_60",
    "momentum_120",
    ...
    "low_volatility_20",
    "low_volatility_60",
    "low_downside_volatility_20",
    "liquidity_resilience_20",
    "crash_recovery_20",
    "recovery_quality_20",
    "trend_resilience_20",
    "defensive_reversal_20",
    "liquidity_confirmed_breakout_20",
)
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Run a clean-universe close-price portfolio diagnostic for technical factors."
    )
    ...
    parser.add_argument("--top-n-values", default="50,100")
