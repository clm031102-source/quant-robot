...
from quant_robot.factors.public_trend_strength_state import (  # noqa: E402
...
from quant_robot.ops.public_trend_strength_state_residual_prescreen import (  # noqa: E402
    build_public_trend_strength_state_residual_prescreen,
...
DEFAULT_OUTPUT_DIR = Path("data/reports/public_trend_strength_state_residual_prescreen_round219_20260624")


def run_public_trend_strength_state_residual_prescreen_cli(
    *,
    ...
    if factor_frame is not None and labels is not None:
        ...
        result = build_public_trend_strength_state_residual_prescreen(
    ...
    write_public_trend_strength_state_residual_prescreen(output_dir, result)
    return result


def main() -> None:
    parser = argparse.ArgumentParser(
        description="Run Round219 public trend-strength-state residual IC and reference de-duplication prescreen."
    )
    ...
    result = run_public_trend_strength_state_residual_prescreen_cli(
        ...
        candidate_factor_names=tuple(args.candidate_factor_names or PUBLIC_TREND_STRENGTH_STATE_FACTOR_NAMES),
