...
from quant_robot.ops.cn_calendar_seasonality_residual_prescreen import (  # noqa: E402
    build_cn_calendar_seasonality_residual_prescreen,
    write_cn_calendar_seasonality_residual_prescreen,
)


DEFAULT_OUTPUT_DIR = Path("data/reports/cn_calendar_seasonality_residual_prescreen_round164_20260623")
DEFAULT_BARS_ROOTS = [
...
DEFAULT_PREREGISTRATION = Path(
    "data/reports/cn_calendar_seasonality_preregistration_round163_20260623/cn_calendar_seasonality_preregistration.json"
)


def run_cn_calendar_seasonality_residual_prescreen_cli(
    *,
    ...
    result = build_cn_calendar_seasonality_residual_prescreen(
        bars_roots=roots,
    ...
    write_cn_calendar_seasonality_residual_prescreen(output_dir, result)
    return result


def main() -> None:
    parser = argparse.ArgumentParser(description="Run Round164 CN calendar-seasonality residual prescreen.")
    ...
    parser.add_argument("--min-calendar-dates", type=int, default=20)
    ...
    result = run_cn_calendar_seasonality_residual_prescreen_cli(
        ...
        min_calendar_dates=args.min_calendar_dates,
    )
    print(
        json.dumps(
            {
