...
from quant_robot.ops.industry_neutral_ic_audit import (  # noqa: E402
...
DEFAULT_OUTPUT_DIR = Path("data/reports/industry_neutral_ic_audit")


def run_industry_neutral_ic_audit(
    *,
    ...
    write_industry_neutral_ic_audit(output_dir, audit)
    return audit


def main() -> None:
    parser = argparse.ArgumentParser(description="Audit factor IC after stripping industry cross-sectional exposure.")
    ...
    parser.add_argument("--min-neutral-retention", type=float, default=0.5)
