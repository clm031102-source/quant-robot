...
from quant_robot.ops.capacity_safe_price_volume_prescreen import (  # noqa: E402
    ...
    write_capacity_safe_price_volume_prescreen,
)
...
DEFAULT_OUTPUT_DIR = Path("data/reports/capacity_safe_price_volume_prescreen")


def run_capacity_safe_price_volume_prescreen_cli(
    *,
    ...
    write_capacity_safe_price_volume_prescreen(output_dir, result)
    return result


def main() -> None:
    parser = argparse.ArgumentParser(
        description="Run long-cycle Alphalens-style IC, quintile, turnover, and capacity prescreen for CN stock price-volume candidates."
    )
