...
- PCF delivery contract: `configs/cn_etf_pcf_delivery_contract.json`; survivorship-reviewed target builder: `scripts/build_cn_etf_pcf_target_universe.py`; structural validator: `scripts/validate_cn_etf_pcf_delivery.py`; cross-exchange source-readiness gate: `scripts/run_cn_etf_pcf_source_readiness.py`
