# Round595 Next Steps Checklist

Use this after pulling `codex/data-pipeline-financial-timeliness-round595-20260705` or after this branch is merged to `main`.

## Operator Start Here

Status: still blocked at 533 / 1,000 unique symbols. No factors, no IC, no grids, no promotion, no 2026 final-holdout read.
...
- Round594 financial reporting timeliness coverage ended at 528 unique symbols and remained blocked.
- Round595 started from clean `main` on a dedicated data-pipeline branch.
...
- Shard 35 offset 9 limit 5 was confirmed as 5 / 5 net-new within financial statement roots.
- Backfilled symbols: `300144.SZ`, `600185.SH`, `301108.SZ`, `000932.SZ`, `002269.SZ`.
- Backfill passed with blockers `[]`, 579 endpoint requests, 193 processed rows, and 0 duplicate rows.
- Aggregate source audit improved coverage to 533 unique symbols and 113,881 rows.
...
2. If continuing financial reporting timeliness, continue shard 35 from offset 14 with a financial-root overlap preview first.
...
- Do not generate financial reporting timeliness factors from the 533-symbol cache.
