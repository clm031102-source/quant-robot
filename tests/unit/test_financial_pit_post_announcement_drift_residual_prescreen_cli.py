...
from scripts.run_financial_pit_post_announcement_drift_residual_prescreen import (
    run_financial_pit_post_announcement_drift_residual_prescreen_cli,
)
from tests.unit.test_financial_pit_post_announcement_drift_residual_prescreen import (
    _financial_rows,
    _seed_all_candidates,
    _write_bars,
    _write_daily_basic,
    _write_financial,
    _write_stock_basic,
...
class FinancialPitPostAnnouncementDriftResidualPrescreenCliTests(unittest.TestCase):
    def test_cli_wrapper_writes_outputs(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.assertTrue((output_dir / "financial_pit_post_announcement_drift_residual_prescreen.json").exists())
            self.assertTrue((output_dir / "financial_pit_post_announcement_drift_residual_prescreen.md").exists())
            self.assertTrue((output_dir / "financial_pit_post_announcement_drift_residual_ic_results.csv").exists())
