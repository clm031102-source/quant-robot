...
from quant_robot.research.household_diagnostic_registration import DIRECTORY, claim_attempt
...
class HouseholdPMGateTests(unittest.TestCase):
    def setUp(self):
        ...
        self.family['household_diagnostic_decision'] = scheduler['household_diagnostic_decision']
    ...
    def test_only_new_exact_study_is_open_with_zero_general_budget(self):
        ...
        self.assertEqual(result['mode'], 'single_household_diagnostic_only')
        self.assertTrue(result['safety']['household_diagnostic_allowed'])
    ...
    def test_broadened_permission_and_auxiliary_stock_selection_remain_blocked(self):
        altered = copy.deepcopy(self.family); altered['household_diagnostic_decision']['promotion_allowed'] = True
