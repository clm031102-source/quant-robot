...
class CheckPlanTests(unittest.TestCase):
    ...
    def test_desktop_validation_profile_runs_safety_checks_then_residual_regime_validation(self):
        ...
        self.assertEqual(
            next(step for step in plan if step.name == "desktop_same_parameter_full_sample_replay").command,
            [
                "python",
        ...
        self.assertEqual(
            ...
            [
                ...
                "--candidates-csv",
                "data/reports/same_parameter_full_sample_replay_tushare_moneyflow_residual_regime/same_parameter_full_sample_replay.csv",
                "--manifest-json",
    ...
    def test_desktop_daily_basic_validation_profile_runs_soft_capacity_bucket_validation(self):
        ...
        self.assertEqual(
            next(step for step in plan if step.name == "desktop_daily_basic_same_parameter_full_sample_replay").command,
            [
                "python",
                "scripts/run_same_parameter_full_sample_replay.py",
                "--candidates-csv",
        ...
        self.assertEqual(
            ...
            [
                ...
                "scripts/run_long_cycle_factor_replay.py",
                "--candidates-csv",
                "data/reports/same_parameter_full_sample_replay_cn_stock_daily_basic_value_low_turnover_bucket_20260620/same_parameter_full_sample_replay.csv",
                "--manifest-json",
                "data/reports/cn_stock_data_manifest/cn_stock_data_manifest.json",
                "--market",
                "CN",
    ...
    def test_desktop_daily_basic_value_size_liquidity_profile_runs_full_gate_chain(self):
        ...
        self.assertEqual(
            ...
            [
                ...
                "desktop_daily_basic_value_size_liquidity_same_parameter_full_sample_replay",
        ...
        self.assertEqual(
            next(step for step in plan if step.name == "desktop_daily_basic_value_size_liquidity_same_parameter_full_sample_replay").command,
            [
                "python",
                "scripts/run_same_parameter_full_sample_replay.py",
                "--candidates-csv",
        ...
        self.assertEqual(
            ...
            [
                ...
                "scripts/run_long_cycle_factor_replay.py",
                "--candidates-csv",
                "data/reports/same_parameter_full_sample_replay_cn_stock_daily_basic_value_size_liquidity_20260620/same_parameter_full_sample_replay.csv",
                "--manifest-json",
                "data/reports/cn_stock_data_manifest/cn_stock_data_manifest.json",
                "--market",
                "CN",
    ...
    def test_desktop_price_volume_technical_profile_runs_full_gate_chain_without_daily_basic_inputs(self):
        ...
        self.assertEqual(
            ...
            [
                ...
                "desktop_price_volume_technical_same_parameter_full_sample_replay",
        ...
        self.assertEqual(
            next(step for step in plan if step.name == "desktop_price_volume_technical_same_parameter_full_sample_replay").command,
            [
                "python",
                "scripts/run_same_parameter_full_sample_replay.py",
                "--candidates-csv",
        ...
        self.assertEqual(
            ...
            [
                ...
                "scripts/run_long_cycle_factor_replay.py",
                "--candidates-csv",
                "data/reports/same_parameter_full_sample_replay_cn_stock_price_volume_technical_20260620/same_parameter_full_sample_replay.csv",
                "--manifest-json",
                "data/reports/cn_stock_data_manifest/cn_stock_data_manifest.json",
                "--market",
                "CN",
